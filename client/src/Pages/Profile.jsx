...
import { User, Shield, Clock, LogOut, Edit, Trash2 } from "lucide-react"
            ...
            <div className='h-screen bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center px-4'>
                ...
                >
                    ...
                    <div className='space-y-3'>
                        <motion.button
                            onClick={ ()=> alert("Will be added an future ! stay connected")}
                            whileTap={{ scale: 0.95 }}
                        ...
                        <motion.button
                            ...
                            className='w-full flex items-center justify-center gap-2 bg-red-700 hover:bg-red-800 text-white py-2 rounded-lg cursor-pointer transition'
                        >
                        ...
                        >
                            ...
                            <div className='mt-6 flex gap-3'>
                                <button
                                    ...
                                    className='flex-1 py-2 rounded-xl bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium transition'
                                >
                                    Cancel
                                </button>
                                <button
